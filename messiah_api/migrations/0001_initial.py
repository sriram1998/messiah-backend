# Generated by Django 3.0.3 on 2020-02-08 10:10
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='foodStats',
            fields=[
                ('foodID', models.AutoField(auto_created=True, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Feedback',
            fields=[
                ('feedbackID', models.AutoField(auto_created=True, primary_key=True, serialize=False)),
                ('messName', models.CharField(max_length=25)),
